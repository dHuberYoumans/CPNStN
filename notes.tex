...
\begin{equation}
  Y_a(X) = \Omega(a) X \quad , \quad \Omega(a) = \diag\left( \mat{0}{a_1}{-a_1}{0}, \dots, \mat{0}{a_{n+1}}{-a_{n+1}}{0} \right)
  \label{eq:Tej_deformation}
\end{equation}
for some $a\in \RR^{n+1}$.
...
\begin{equation}
  \su(n) \equiv \mat{0}{0}{\su(n)}{0} \subset \su(n+1)
\end{equation}
We then find 
\begin{equation}
