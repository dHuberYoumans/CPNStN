...
\end{equation}
% Let us close both eyes and make a series expansion of the exponential and swap the order of sum and integral.
% Then 
% \begin{equation}
%   \left\langle \OO_{ij}(U) \right\rangle = \frac{\vol}{Z} \sum_{k} \frac{\beta^k}{k!} \int \mu(U) U_{i1}U^*_{1j} \lvert U_{11} \rvert^{2k}
%   \label{eq:toy_one_pt_from_SU}
% \end{equation}
...
%     &= \frac{1}{\vol} \Big[ \delta_{ij}^2 \Big(\Wg^{n+1}(1^2) + \Wg^{n+1}(12)\Big) + \delta_{ii}\delta_{jj} \Big(\delta_{i1}\delta_{j1}\Wg^{n+1}(1^2) + \Wg^{n+1}(12)\Big)\Big] \\
  \end{split}
\end{equation}
...
\begin{thebibliography}{99}
  \bibitem{Borisenko_Voloshyn_Chelnokov} O.\ Borisenko, S.\  Voloshyn and V.\ Chelnokov. SU(N) Polynomial Integrals and Some Applications. Rept. Math. Phys. 85, 129–145. arXiv: \href{https://arxiv.org/abs/1812.06069}{1812.06069 [hep-lat]} (2020).
  ...
  \bibitem{Zhang} L.\ Zhang. Volumes of Orthogonal Groups and Unitary Groups. preprint. arXiv: \href{https://arxiv.org/abs/1509.00537v5}{1509.00537}
\end{thebibliography}
\end{document}
